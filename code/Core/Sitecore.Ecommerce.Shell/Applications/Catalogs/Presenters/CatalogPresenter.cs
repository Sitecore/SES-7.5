...
namespace Sitecore.Ecommerce.Shell.Applications.Catalogs.Presenters
{
  ...
  public class CatalogPresenter
  {
    ...
    private List<TextBoxDefinition> TextBoxDefinitions
    {
      get
      {
        if (this.textBoxDefinitions == null)
        {
          this.textBoxDefinitions = this.Catalog.GetTextBoxDefinitions();
        }

        return this.textBoxDefinitions;
      }
    }
    ...
    {
      ItemUri ribbounSourceUri = this.Catalog.GetRibbonSourceUri();
    ...
    {
      SearchOptions options = this.CreateSearchOptions();
      this.Search(options);
    }
    ...
    {
      CatalogBaseSource source = this.Catalog.CatalogSource;
      if (source == null)
      {
        return;
      }
