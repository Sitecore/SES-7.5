...
namespace Sitecore.Ecommerce.Shell.Applications.Catalogs.Views
{
  ...
  /// </summary>
  public class ProductCatalogView : CatalogView, IProductCatalogView, IHasCommandContext
  {
    /// <summary>
    ...
    {
      ListString selectedProducts = this.SelectedProducts;
    ...
    protected override void OnAjaxScriptManagerExecute(object sender, AjaxCommandEventArgs args)
    {
      ...
      switch (args.Name)
      {
        ...
        case "productcatalog:addbuttonclick":
          {
            GridCommandEventArgs gridArgs = new GridCommandEventArgs { RowsID = new StringCollection() };
            ListString rowIDs = new ListString(args.Parameters["rowIDs"]);
