...
namespace Sitecore.Ecommerce
{
  ...
  public class IoCContainer : IIoCContainer
  {
    ...
    {
      string entityName = string.Format("{0}_{1}", Sitecore.Context.Site.Name, Sitecore.Context.Database.Name);

      try
      {
        ConfigurationPipelineArgs args = new ConfigurationPipelineArgs(typeof(T)) { EntityName = entityName };
    ...
    public virtual void SetInstance<T>(T entity)
    {
      ...
      string entityName = this.GenerateEntityName<T>();
      ...
      {
        T storedEntity = (T)HttpContext.Current.Session[entityName];
    ...
    public virtual T GetInstance<T>()
    {
      ...
      object entityObject = HttpContext.Current.Session[entityName];
      T entity;
    ...
    protected string GetSiteBasedName(string name)
    {
      ...
      string siteName = contextSite.Name;
